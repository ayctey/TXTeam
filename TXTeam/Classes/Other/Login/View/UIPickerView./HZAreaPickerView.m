...
- (void)showInView:(UIView *) view
{
    ...
    Clearview=[[UIView alloc]initWithFrame:self.bounds];
    Clearview.backgroundColor=[UIColor colorWithRed:0 green:0 blue:0 alpha:0.4];
    [self addSubview:Clearview];
    UIView *_view =[[UIView alloc]initWithFrame:CGRectMake(0, kScreenHeight-250, kScreenWidth, 220)];
    _view.backgroundColor=[UIColor whiteColor];
    [Clearview addSubview:_view];
    [_view addSubview:self.locatePicker];
    self.locatePicker.frame=CGRectMake((kScreenWidth-320)/2, 0, 320, 0);
    //self.locatePicker.alpha=1.0;
